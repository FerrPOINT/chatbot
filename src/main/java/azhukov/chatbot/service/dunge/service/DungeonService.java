...
public class DungeonService {
    ...
    private String getHeroMessage(FightResult fight) {
        ...
        return (fight.isReborn() ? "Босс победил вас, но вам чудом удалось выжить. " : "Вы сбежали из-за опасности. ") + (damageGet.getValue() <= 0 ? "Вы всё задоджили " :
    ...
    public String getHeroesListResponse() {
        return HeroClass.VALUES.stream()
                .map(heroClass -> heroClass.getLabel() + " - " + heroClass.getAbilityName() + ": " + heroClass.getAbilityDescription())
